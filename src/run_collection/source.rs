...
fn source_catalog() -> Vec<SourceSpec> {
    vec![
        // Local k=8, k=9 runs (from erdos396 -k 8/9 --significant-run-threshold 6)
        SourceSpec {
            rel_path: "data/k8_runs",
            source_label: "local_k8_0_340M",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::RunLogV3,
            server: "local",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "data/k9_runs",
            source_label: "local_k9_0_1_02B",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::RunLogV3,
            server: "local",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "checkpoints",
            source_label: "local_k10_checkpoints",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "local",
            recursive: false,
            checkpoint_prefix: Some("checkpoint_k10_"),
        },
        SourceSpec {
            rel_path: "chi/verify_k10",
            source_label: "chi_k10_verify_1M_18B",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "chi",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "chi/k11_search",
            source_label: "chi_k11_18B_200B",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "chi",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "honeybear_backup_2026-01-30/k11_search_200_400",
            source_label: "honeybear_k11_200B_400B",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "honeybear",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "chi/k11_search_400_600",
            source_label: "chi_k11_400B_600B",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "chi",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "honeybear_backup_2026-01-30/k11_search_600_800",
            source_label: "honeybear_k11_600B_800B",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "honeybear",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "honeybear_backup_2026-01-30/k11_search_800_850",
            source_label: "honeybear_k11_800B_850B",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "honeybear",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "archives/chi_k11_850B-1T",
            source_label: "chi_k11_850B_1T",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "chi",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "archives/honeybear_k11_1T-2T",
            source_label: "honeybear_k11_1T_2T",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "honeybear",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "archives/chi_k11_2T-2.5T",
            source_label: "chi_k11_2T_2_5T",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "chi",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "archives/chi_k12_2.5T-5T",
            source_label: "chi_k12_2_5T_5T",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "chi",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "archives/honeybear_k12_5T-10T",
            source_label: "honeybear_k12_5T_10T",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "honeybear",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "archives/chi_k12_10T-15T",
            source_label: "chi_k12_10T_15T",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::CheckpointV2,
            server: "chi",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "archives/chi_k13_15T-25T",
            source_label: "chi_k13_15T_25T",
            archive_role: ArchiveRole::Canonical,
            source_kind: SourceKind::RunLogV3,
            server: "chi",
            recursive: false,
        ...
        SourceSpec {
            rel_path: "archives/chi_k12_gap_5T-6.15T",
            source_label: "chi_k12_gap_5T_6_15T",
        ...
        SourceSpec {
            rel_path: "archives/chi_k13_15T-25T_v2_final",
            source_label: "chi_k13_15T_25T_v2_final",
