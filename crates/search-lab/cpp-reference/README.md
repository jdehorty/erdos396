...
## erdos_problem_396.cpp — Reference Implementation
...
Key techniques pioneered in this implementation:
...
## main.cpp — Ported Implementation

Our C++ port with additional optimizations. Build with `just build` (see justfile).
